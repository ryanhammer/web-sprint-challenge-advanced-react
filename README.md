...
Stateful components allow us to make use of life cycle hook methods based on the React component lifecycle. A functional component uses effect hooks rather than component lifecycle.
